     ...
     base.instance_eval do
       def inherit_from(klass, options = {})
         ...
         attributes.each do |attribute|
           ...
           if Object.const_defined?('ActiveModel::Validations') && klass.ancestors.include?(ActiveModel::Validations)
       ...
       def get_attributes(klass, options)
         ...
         elsif Object.const_defined?('ActiveRecord::Base') && klass.ancestors.include?(ActiveRecord::Base)
